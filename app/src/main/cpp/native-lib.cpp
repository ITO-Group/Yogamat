...
Java_com_example_zhoujianyu_yogamat_MainActivity_readDiffStart(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_zhoujianyu_yogamat_MainActivity_readDiffStop(JNIEnv *env, jobject instance) {
